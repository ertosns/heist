...
note that the off-chain agreement is done with probabilistic winners, it be guaranteed 100%, but once this attack is done once (even if possible with low probability), the adversaries will have high leverage on winning, by mining lowest possible \emph{y}.
